...
@onready var unit_scene := preload("res://assets/infantry/heavyinfantry.tscn")
...
@onready var player_manager = get_node("/root/grid/Player1/player_manager")
...
const delay := 5.0
const label := "spawn heavy infantry"
